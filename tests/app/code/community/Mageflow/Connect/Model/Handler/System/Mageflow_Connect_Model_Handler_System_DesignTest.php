...
class Mageflow_Connect_Model_Handler_System_DesignTest  extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mageflow_Connect_Model_Handler_System_Design
     */
    protected $object;
    protected $testmodel;
...
//        $this->object =  Mage::getModel('Mage_Core_Model_Design');
        $this->object = new Mageflow_Connect_Model_Handler_System_Design();

        $this->testmodel = Mage::getModel('Mage_Core_Model_Design');

        $now = new Zend_Date();

        $this->testmodel->setData('mf_guid', '123abc');
        $this->testmodel->setData('design', 'default');
        $this->testmodel->setData('store', 'default');
    }
    ...
    public function testPackData()
    {
        ...
        $this->assertObjectHasAttribute('design', $retval);
        $this->assertObjectHasAttribute('store', $retval);
    }
    ...
    public function testGetPreview()
    {
        ...
        $this->assertEquals($retval, 'default');
    }
