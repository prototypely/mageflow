...
class Mageflow_Connect_Model_Handler_Sales_TaxruleTest  extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->object = new Mageflow_Connect_Model_Handler_Sales_Taxrule();

        $this->testmodel = Mage::getModel('Mage_Tax_Model_Calculation_Rule');

        $now = new Zend_Date();

        $this->testmodel->setData('mf_guid', '123abc');
        $this->testmodel->setData('code', 'testrule');
    }
    ...
    public function testGetPreview()
    {
        ...
        $this->assertEquals($retval, 'testrule');
    }
