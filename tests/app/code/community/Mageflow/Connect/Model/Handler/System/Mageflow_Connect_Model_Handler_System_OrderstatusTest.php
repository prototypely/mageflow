...
class Mageflow_Connect_Model_Handler_System_OrderstatusTest  extends PHPUnit_Framework_TestCase
{
    /**
...
//        $this->object =  Mage::getModel('Mage_Core_Model_Orderstatus');
        ...
        $this->testmodel = Mage::getModel('Mage_Sales_Model_Order_Status');

        $now = new Zend_Date();

        $this->testmodel->setData('mf_guid', rand(111111, 999999));
        $this->testmodel->setData('status', 'testing');
        $this->testmodel->setData('label', 'testing');
        $this->testmodel->setData('store_labels', array('1' => 'label1'));
    }
    ...
    public function testPackData()
    {
        ...
        $this->assertObjectHasAttribute('status', $retval);
        $this->assertObjectHasAttribute('label', $retval);
        $this->assertObjectHasAttribute('store_labels', $retval);
    }
