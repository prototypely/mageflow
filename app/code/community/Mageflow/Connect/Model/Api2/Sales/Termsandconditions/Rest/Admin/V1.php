...
/**
 * Mageflow_Connect_Model_Api2_Sales_Termsandconditions_Rest_Admin_V1
 *
 * @category   MFX
 * @package    Mageflow_Connect
 * @subpackage Model
 ...
 * @link       http://mageflow.com/
 */
class Mageflow_Connect_Model_Api2_Sales_Termsandconditions_Rest_Admin_V1
    extends Mageflow_Connect_Model_Api2_Abstract
{
     ...
     * @var string
     */
    protected $_resourceType = 'checkout/agreement';
    ...
    public function _retrieve()
    {
        ...
        if (!is_null($mf_guid)) {
            ...
            $itemCollection->addFieldToFilter(
                array('mf_guid'), array(array('eq'=>array($mf_guid)))
            );
        }
