...
/**
 * Mageflow_Connect_Model_Api2_Sales_Tax_Rate_Rest_Admin_V1
 *
 * @category   MFX
 * @package    Mageflow_Connect
 * @subpackage Model
 ...
 * @link       http://mageflow.com/
 */
class Mageflow_Connect_Model_Api2_Sales_Tax_Rate_Rest_Admin_V1
    extends Mageflow_Connect_Model_Api2_Abstract
{
     ...
     * @var string
     */
    protected $_resourceType = 'tax/calculation_rate';
